   ...
   <div class="container">
      ...
      <div class="row">
         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <h2 class="page-title">Cảm ơn bạn đã mua hàng qua trang web này <span class="shop-pro-item">Giỏ hàng của bạn gồm: {{ $len }} sản phẩm</span></h2>
               ...
               <div class="table-responsive">
                  ...
                  <table class="table table-bordered" id="cart-summary">
                     ...
                     <tbody>
                        ...
                        @for($i = 0;$i < $len;$i++) <!-- SINGLE CART_ITEM START -->
                           <tr id="{{ $cart[$i]['ID'] }}">
                     ...
                     <tfoot>
                            <tr class="cart-total-price">
                                ...
                                <td id="total_product" class="price" colspan="1" style="text-align: right">{{ $total }} vnđ</td>
                            </tr>
                            <tr>
                                <td class="text-right" colspan="3">Phí vận chuyển</td>
                                <td id="total_shipping" class="price" colspan="1" style="text-align: right">0 vnđ</td>
                            </tr>
                            <tr>
                                <td class="text-right" colspan="3">Khuyến mãi</td>
                                <td class="price" colspan="1" style="text-align: right">0 vnđ</td>
                            </tr>
                            <tr>
                                <td class="total-price-container text-right" colspan="3">
                                    <span>Tổng thanh toán</span>
                                </td>
                                <td id="total-price-container" class="price" colspan="1" style="text-align: right">
                                    <span id="total-price" >{{ $total}} vnđ</span>
                                </td>
                            </tr>
                        </tfoot>
                     <!-- TABLE FOOTER END -->
